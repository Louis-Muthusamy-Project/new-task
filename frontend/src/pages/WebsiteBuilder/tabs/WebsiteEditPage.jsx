...
function normalizeWebsite(doc) {
  ...
  return {
    ...
    updatedAt: doc.updatedAt
      ...
      : "Just now",
    pages: pageCount,
    // Preserve both raw page objects and the settings fields WebsiteEditPage
    // needs (chatWidgetId, tracking, faviconUrl, domain) — otherwise they get
    // wiped out every time the list is refetched and the edit page is reopened.
