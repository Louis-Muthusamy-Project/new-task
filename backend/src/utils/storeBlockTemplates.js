...
const THEME_COMPONENT_MAP = {
  ...
  'featured-products': 'ImportedFeaturedProducts',
  'category-grid': 'CollectionsGrid',
  'latest-products': 'ImportedLatestProducts',
  'best-sellers': 'ImportedBestSellers',
  'related-products': 'ImportedRelatedProducts',
  'sale-products': 'ImportedSaleProducts',
  'category-products': 'ImportedCategoryProducts',
  'product-detail': 'ImportedProductDetail',
  cart: 'ImportedCart',
  checkout: 'ImportedCheckout',
  wishlist: 'ImportedWishlist',
  'wishlist-button': 'WishlistButton',
  pagination: 'ImportedPagination',
